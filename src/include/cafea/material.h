...
class Material: public ObjectBase {
	public:
		 ...
		 */
		Material(int id, MaterialType mtype): mtype_(mtype), ObjectBase {id, fmt::format("Material#{0}", id)} {}
		/**
		 ...
		 */
		Material(int id, MaterialType mtype, init_list_<T> val): mtype_(mtype), ObjectBase {id, fmt::format("Material#{0}", id)} {
		 ...
		 */
		Material(int id, MaterialType mtype, init_list_<T> va, init_list_<T> vb): mtype_(mtype),
