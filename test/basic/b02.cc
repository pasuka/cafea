...
TEST_CASE("init", "[NodeBase]")
{
    ...
    {
        Node<> pt(53, CoordinateSystem::CYLINDRICAL);
    ...
    {
        Node<> pt(61, CoordinateSystem::SPHERICAL, 1.1f, 2.3f, 3.1f);
    ...
    {
        Node<> pt(59, {1.f, 2.f, 3.f}, {1.2f, 2.3f, 3.4f});
...
TEST_CASE("coord tran", "[NodeBase]")
{
    SECTION("01 line")
    {
        Node<> pt[2]{{3, {1.f, 0.f, 10.f}}, {5, {2.f, 0.f, 10.f}}};
    ...
    SECTION("04 triangle")
    {
        Node<> pt[3]{{3, {1.f, 0.f, 10.f}}, {5, {2.f, 0.f, 10.f}}, {7, {0.f, .5f, 10.f}}};
        auto rst = NodeFunc<float, double>::coord_tran(pt, &pt[1], &pt[2]);
        REQUIRE(std::get<0>(rst)==Approx(.25f).epsilon(0.0001f));
    }
    SECTION("05 quadrangle")
    {
        Node<> pt[4]{{3, {0.f, 0.f, 0.f}}, {5, {1.f, 0.f, 0.f}}, {7, {1.f, 1.f, 0.f}}, {11, {0.f, 1.f, 0.f}}};
